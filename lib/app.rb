...
# say hello to the sample of 5 journalists
def hastag_hello(user)
    user = journalists.sample(5)
    client.filter(track: journalists.join(",")) do |object|
      ...
      client.user do |object|
          case object
            ...
            when Twitter::DirectMessage
             puts "A Great project for all people! THP code for fun!!"
            when Twitter::Streaming::StallWarning
            warn "If you want to learn Ruby with a few!! Join THP"
          end
    end
end
#follow the hastag bonjours
def hastag_follow_bonjour
  client.follow('#_bonjour')
end
# like the hastag bonjour 
def like_hastag_bonjour
  client.user do |object|
    if Twitter::Streaming
      puts "Streaming and like and follow hastag_bonjour."
    end
end